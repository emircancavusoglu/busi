...
class ProfitableAnalysisView extends StatefulWidget {
  ProfitableAnalysisView({super.key});

  @override
  State<ProfitableAnalysisView> createState() => _ProfitableAnalysisViewState();
}

class _ProfitableAnalysisViewState extends State<ProfitableAnalysisView> {
