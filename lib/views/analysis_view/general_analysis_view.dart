...
class GeneralAnalysisView extends StatefulWidget {
  GeneralAnalysisView({super.key});

  @override
  State<GeneralAnalysisView> createState() => _GeneralAnalysisViewState();
}

class _GeneralAnalysisViewState extends State<GeneralAnalysisView> {
