...
class VerticalAnalysisView extends StatefulWidget {
  VerticalAnalysisView({super.key});

  @override
  State<VerticalAnalysisView> createState() => _VerticalAnalysisViewState();
}

class _VerticalAnalysisViewState extends State<VerticalAnalysisView> {
