...
class DuPontAnalysisView extends StatefulWidget {
  DuPontAnalysisView({super.key});

  @override
  State<DuPontAnalysisView> createState() => _DuPontAnalysisViewState();
}

class _DuPontAnalysisViewState extends State<DuPontAnalysisView> {
